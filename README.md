...
[ASCS/ERS]-VIRT-HOSTNAME | ASCS/ERS virtual hostnames.  <br /> Default values:  "sap[ascs/ers]". When the default value is used, the virtual hostname will automatically be changed based on <SAP_SID> to "sap<sap_sid>[ascs/ers]"
